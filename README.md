# 📃  lingo : Learn Languages with Fun!
...
# 📃 Al Azhar University 
- ahmad maher mohammed hasouna                      20211709
- hasan hisham mohammed hasouna                     20211915 

 # 📃 SUPERVISED BY          Dr: omar alnahaal
...
```bash
git clone https://github.com/ahmadmaher-19/lingo.git
```
